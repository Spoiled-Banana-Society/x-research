...
import { setManageSelectedCard, setManageView } from "@/redux/manageSlice"
import { positionColor, COLORS } from "@/utils/helpers"
...
const BoardItemComponent: React.FC<BoardItemProps> = (props) => {
    const { item } = props
    ...
    return (
        <StyledBlock
            ...
            onClick={() => {
                dispatch(setManageSelectedCard(item.playerInfo.ownerAddress))
                dispatch(setManageView(ViewState.ROSTER))
            }}
            style={{
