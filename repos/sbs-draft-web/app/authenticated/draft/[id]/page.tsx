...
import { setLeagueLevel, clearLeague } from "@/redux/leagueSlice"
import { clearDraft } from "@/redux/draftSlice"
...
const Draft = ({ params }: { params: { id: string } }) => {
    ...
    // Cleanup Redux state when component unmounts or when draft ID changes
    useEffect(() => {
        // Cleanup function - called when component unmounts or params.id changes
        return () => {
