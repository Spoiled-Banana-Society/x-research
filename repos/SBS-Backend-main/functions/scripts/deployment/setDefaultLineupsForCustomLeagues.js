...
========================
    ...
    👣 Deployment Steps: node setDefaultLineupsForCustomLeagues.js
...
const SCRIPT_NAME = "Set Default Lineups for custom leagues" //required
...
const run = async () => {
  ...
  leagueIds = leagueIds.filter(x => x != 'genesis'); 
