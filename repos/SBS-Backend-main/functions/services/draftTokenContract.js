...
const PROVIDER_ENDPOINT = `https://mainnet.infura.io/v3/${INFURA_PROJECT_ID}`;
...
const GOERLI_CARD_CONTRACT_ADDRESS = ""
//const CONTRACT_ADDRESS = (NETWORK === 'mainnet') ? MAINNET_CARD_CONTRACT_ADDRESS : GOERLI_CARD_CONTRACT_ADDRESS;
// const CONTRACT_ADDRESS = "0x82194174d56b6df894460e7754a9cC69a0c1707D";
const CONTRACT_ADDRESS = "0x2BfF6f4284774836d867CEd2e9B96c27aAee55B7";
...
const ABI = [
  ...
  {
      "inputs": [],
      "name": "SPOILEDBANANASOCIETY_PROVENANCE",
      "outputs": [
          {
              "internalType": "string",
              "name": "",
